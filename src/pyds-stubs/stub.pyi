...
NvDsMetaList: TypeAlias = typing.Optional[GList[NvDsMeta]]
...
class NvOSD_Mode:
    ...
    __members__: typing.ClassVar[
        dict[str, NvOSD_Mode]
    ]  # value = {'MODE_CPU': NvOSD_Mode.MODE_CPU, 'MODE_GPU': NvOSD_Mode.MODE_GPU, 'MODE_HW': NvOSD_Mode.MODE_HW}
...
NvDsUserMetaList: TypeAlias = typing.Optional[GList[NvDsUserMeta]]
...
NvDisplayMetaList: TypeAlias = typing.Optional[GList[NvDsDisplayMeta]]
...
NvDsFrameMetaList: TypeAlias = typing.Optional[GList[NvDsFrameMeta]]
...
NvDsObjectMetaList: TypeAlias = typing.Optional[GList[NvDsObjectMeta]]
