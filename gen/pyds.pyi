...
class GstNvDsMetaType:
    ...
    """
    NVDS_BATCH_GST_META: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_BATCH_GST_META: 4097>
    NVDS_DECODER_GST_META: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_DECODER_GST_META: 4098>
    NVDS_DEWARPER_GST_META: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_DEWARPER_GST_META: 4099>
    NVDS_GST_INVALID_META: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_GST_INVALID_META: -1>
    NVDS_GST_META_FORCE32: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_GST_META_FORCE32: 2147483647>
    NVDS_RESERVED_GST_META: typing.ClassVar[GstNvDsMetaType]  # value = <GstNvDsMetaType.NVDS_RESERVED_GST_META: 8192>
    __members__: typing.ClassVar[dict[str, GstNvDsMetaType]]  # value = {'NVDS_GST_INVALID_META': <GstNvDsMetaType.NVDS_GST_INVALID_META: -1>, 'NVDS_BATCH_GST_META': <GstNvDsMetaType.NVDS_BATCH_GST_META: 4097>, 'NVDS_DECODER_GST_META': <GstNvDsMetaType.NVDS_DECODER_GST_META: 4098>, 'NVDS_DEWARPER_GST_META': <GstNvDsMetaType.NVDS_DEWARPER_GST_META: 4099>, 'NVDS_RESERVED_GST_META': <GstNvDsMetaType.NVDS_RESERVED_GST_META: 8192>, 'NVDS_GST_META_FORCE32': <GstNvDsMetaType.NVDS_GST_META_FORCE32: 2147483647>}
    ...
    def value(self) -> int:
        ...
class GstNvDsPreProcessBatchMeta:
    """
    Batch metadata structure for preprocessing operations.
                    ...
                    :ivar private_data: *capsule*, pointer to buffer from scaling pool.
    """
    private_data: capsule
    roi_vector: list[NvDsRoiMeta]
    target_unique_ids: list[int]
    tensor_meta: NvDsPreProcessTensorMeta
    def __init__(self) -> None:
        ...
    def cast(self: capsule) -> GstNvDsPreProcessBatchMeta:
        """
        Cast given object/data to :class:`GstNvDsPreProcessBatchMeta`, call pyds.GstNvDsPreProcessBatchMeta.cast(data)
        """
class NvBbox_Coords:
    """
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvBbox_Coords:
        """
...
class NvBufSurface:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvBufSurface:
        """
...
class NvBufSurfaceColorFormat:
    ...
    *Enumerator*. Specifies color formats for :class:`NvBufSurface`.
    ...
    """
    NVBUF_COLOR_FORMAT_ABGR: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ABGR: 22>
    NVBUF_COLOR_FORMAT_ARGB: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ARGB: 21>
    NVBUF_COLOR_FORMAT_BGR: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGR: 28>
    NVBUF_COLOR_FORMAT_BGRA: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRA: 20>
    NVBUF_COLOR_FORMAT_BGRx: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRx: 24>
    NVBUF_COLOR_FORMAT_GRAY8: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_GRAY8: 1>
    NVBUF_COLOR_FORMAT_INVALID: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_INVALID: 0>
    NVBUF_COLOR_FORMAT_LAST: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_LAST: 104>
    NVBUF_COLOR_FORMAT_NV12: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12: 6>
    NVBUF_COLOR_FORMAT_NV12_10LE: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE: 29>
    NVBUF_COLOR_FORMAT_NV12_10LE_2020: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_2020: 40>
    NVBUF_COLOR_FORMAT_NV12_10LE_709: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709: 38>
    NVBUF_COLOR_FORMAT_NV12_10LE_709_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709_ER: 39>
    NVBUF_COLOR_FORMAT_NV12_10LE_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_ER: 37>
    NVBUF_COLOR_FORMAT_NV12_12LE: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_12LE: 30>
    NVBUF_COLOR_FORMAT_NV12_2020: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_2020: 36>
    NVBUF_COLOR_FORMAT_NV12_709: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709: 33>
    NVBUF_COLOR_FORMAT_NV12_709_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709_ER: 34>
    NVBUF_COLOR_FORMAT_NV12_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_ER: 7>
    NVBUF_COLOR_FORMAT_NV21: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21: 8>
    NVBUF_COLOR_FORMAT_NV21_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21_ER: 9>
    NVBUF_COLOR_FORMAT_RGB: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGB: 27>
    NVBUF_COLOR_FORMAT_RGBA: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBA: 19>
    NVBUF_COLOR_FORMAT_RGBx: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBx: 23>
    NVBUF_COLOR_FORMAT_SIGNED_R16G16: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_SIGNED_R16G16: 41>
    NVBUF_COLOR_FORMAT_UYVY: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY: 10>
    NVBUF_COLOR_FORMAT_UYVY_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY_ER: 11>
    NVBUF_COLOR_FORMAT_VYUY: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY: 12>
    NVBUF_COLOR_FORMAT_VYUY_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY_ER: 13>
    NVBUF_COLOR_FORMAT_YUV420: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420: 2>
    NVBUF_COLOR_FORMAT_YUV420_2020: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_2020: 35>
    NVBUF_COLOR_FORMAT_YUV420_709: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709: 31>
    NVBUF_COLOR_FORMAT_YUV420_709_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709_ER: 32>
    NVBUF_COLOR_FORMAT_YUV420_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_ER: 4>
    NVBUF_COLOR_FORMAT_YUV444: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV444: 18>
    NVBUF_COLOR_FORMAT_YUYV: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV: 14>
    NVBUF_COLOR_FORMAT_YUYV_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV_ER: 15>
    NVBUF_COLOR_FORMAT_YVU420: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420: 3>
    NVBUF_COLOR_FORMAT_YVU420_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420_ER: 5>
    NVBUF_COLOR_FORMAT_YVYU: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU: 16>
    NVBUF_COLOR_FORMAT_YVYU_ER: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU_ER: 17>
    NVBUF_COLOR_FORMAT_xBGR: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xBGR: 26>
    NVBUF_COLOR_FORMAT_xRGB: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xRGB: 25>
    __members__: typing.ClassVar[dict[str, NvBufSurfaceColorFormat]]  # value = {'NVBUF_COLOR_FORMAT_INVALID': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_INVALID: 0>, 'NVBUF_COLOR_FORMAT_GRAY8': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_GRAY8: 1>, 'NVBUF_COLOR_FORMAT_YUV420': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420: 2>, 'NVBUF_COLOR_FORMAT_YVU420': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420: 3>, 'NVBUF_COLOR_FORMAT_YUV420_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_ER: 4>, 'NVBUF_COLOR_FORMAT_YVU420_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420_ER: 5>, 'NVBUF_COLOR_FORMAT_NV12': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12: 6>, 'NVBUF_COLOR_FORMAT_NV12_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_ER: 7>, 'NVBUF_COLOR_FORMAT_NV21': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21: 8>, 'NVBUF_COLOR_FORMAT_NV21_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21_ER: 9>, 'NVBUF_COLOR_FORMAT_UYVY': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY: 10>, 'NVBUF_COLOR_FORMAT_UYVY_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY_ER: 11>, 'NVBUF_COLOR_FORMAT_VYUY': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY: 12>, 'NVBUF_COLOR_FORMAT_VYUY_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY_ER: 13>, 'NVBUF_COLOR_FORMAT_YUYV': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV: 14>, 'NVBUF_COLOR_FORMAT_YUYV_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV_ER: 15>, 'NVBUF_COLOR_FORMAT_YVYU': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU: 16>, 'NVBUF_COLOR_FORMAT_YVYU_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU_ER: 17>, 'NVBUF_COLOR_FORMAT_YUV444': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV444: 18>, 'NVBUF_COLOR_FORMAT_RGBA': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBA: 19>, 'NVBUF_COLOR_FORMAT_BGRA': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRA: 20>, 'NVBUF_COLOR_FORMAT_ARGB': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ARGB: 21>, 'NVBUF_COLOR_FORMAT_ABGR': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ABGR: 22>, 'NVBUF_COLOR_FORMAT_RGBx': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBx: 23>, 'NVBUF_COLOR_FORMAT_BGRx': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRx: 24>, 'NVBUF_COLOR_FORMAT_xRGB': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xRGB: 25>, 'NVBUF_COLOR_FORMAT_xBGR': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xBGR: 26>, 'NVBUF_COLOR_FORMAT_RGB': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGB: 27>, 'NVBUF_COLOR_FORMAT_BGR': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGR: 28>, 'NVBUF_COLOR_FORMAT_NV12_10LE': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE: 29>, 'NVBUF_COLOR_FORMAT_NV12_12LE': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_12LE: 30>, 'NVBUF_COLOR_FORMAT_YUV420_709': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709: 31>, 'NVBUF_COLOR_FORMAT_YUV420_709_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709_ER: 32>, 'NVBUF_COLOR_FORMAT_NV12_709': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709: 33>, 'NVBUF_COLOR_FORMAT_NV12_709_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709_ER: 34>, 'NVBUF_COLOR_FORMAT_YUV420_2020': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_2020: 35>, 'NVBUF_COLOR_FORMAT_NV12_2020': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_2020: 36>, 'NVBUF_COLOR_FORMAT_NV12_10LE_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_ER: 37>, 'NVBUF_COLOR_FORMAT_NV12_10LE_709': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709: 38>, 'NVBUF_COLOR_FORMAT_NV12_10LE_709_ER': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709_ER: 39>, 'NVBUF_COLOR_FORMAT_NV12_10LE_2020': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_2020: 40>, 'NVBUF_COLOR_FORMAT_SIGNED_R16G16': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_SIGNED_R16G16: 41>, 'NVBUF_COLOR_FORMAT_LAST': <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_LAST: 104>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvBufSurfaceCreateParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvBufSurfaceCreateParams:
        """
...
class NvBufSurfaceLayout:
    ...
    *Enumerator*. Specifies layout formats for :class:`NvBufSurface` video planes.
    ...
    """
    NVBUF_LAYOUT_BLOCK_LINEAR: typing.ClassVar[NvBufSurfaceLayout]  # value = <NvBufSurfaceLayout.NVBUF_LAYOUT_BLOCK_LINEAR: 1>
    NVBUF_LAYOUT_PITCH: typing.ClassVar[NvBufSurfaceLayout]  # value = <NvBufSurfaceLayout.NVBUF_LAYOUT_PITCH: 0>
    __members__: typing.ClassVar[dict[str, NvBufSurfaceLayout]]  # value = {'NVBUF_LAYOUT_PITCH': <NvBufSurfaceLayout.NVBUF_LAYOUT_PITCH: 0>, 'NVBUF_LAYOUT_BLOCK_LINEAR': <NvBufSurfaceLayout.NVBUF_LAYOUT_BLOCK_LINEAR: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvBufSurfaceMappedAddr:
    ...
    def __release_buffer__(self, buffer):
        ...
        """
    @typing.overload
    def cast(self: capsule) -> NvBufSurfaceMappedAddr:
        """
...
class NvBufSurfaceMemMapFlags:
    ...
    *Enumerator*. Specifies mapping types for :class:`NvBufSurface`.
    ...
    """
    NVBUF_MAP_READ: typing.ClassVar[NvBufSurfaceMemMapFlags]  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ: 0>
    NVBUF_MAP_READ_WRITE: typing.ClassVar[NvBufSurfaceMemMapFlags]  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ_WRITE: 2>
    NVBUF_MAP_WRITE: typing.ClassVar[NvBufSurfaceMemMapFlags]  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_WRITE: 1>
    __members__: typing.ClassVar[dict[str, NvBufSurfaceMemMapFlags]]  # value = {'NVBUF_MAP_READ': <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ: 0>, 'NVBUF_MAP_WRITE': <NvBufSurfaceMemMapFlags.NVBUF_MAP_WRITE: 1>, 'NVBUF_MAP_READ_WRITE': <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ_WRITE: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvBufSurfaceMemType:
    ...
    """
    NVBUF_MEM_CUDA_DEVICE: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_DEVICE: 2>
    NVBUF_MEM_CUDA_PINNED: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_PINNED: 1>
    NVBUF_MEM_CUDA_UNIFIED: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_UNIFIED: 3>
    NVBUF_MEM_DEFAULT: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_DEFAULT: 0>
    NVBUF_MEM_HANDLE: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_HANDLE: 5>
    NVBUF_MEM_SURFACE_ARRAY: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_SURFACE_ARRAY: 4>
    NVBUF_MEM_SYSTEM: typing.ClassVar[NvBufSurfaceMemType]  # value = <NvBufSurfaceMemType.NVBUF_MEM_SYSTEM: 6>
    __members__: typing.ClassVar[dict[str, NvBufSurfaceMemType]]  # value = {'NVBUF_MEM_DEFAULT': <NvBufSurfaceMemType.NVBUF_MEM_DEFAULT: 0>, 'NVBUF_MEM_CUDA_PINNED': <NvBufSurfaceMemType.NVBUF_MEM_CUDA_PINNED: 1>, 'NVBUF_MEM_CUDA_DEVICE': <NvBufSurfaceMemType.NVBUF_MEM_CUDA_DEVICE: 2>, 'NVBUF_MEM_CUDA_UNIFIED': <NvBufSurfaceMemType.NVBUF_MEM_CUDA_UNIFIED: 3>, 'NVBUF_MEM_SURFACE_ARRAY': <NvBufSurfaceMemType.NVBUF_MEM_SURFACE_ARRAY: 4>, 'NVBUF_MEM_HANDLE': <NvBufSurfaceMemType.NVBUF_MEM_HANDLE: 5>, 'NVBUF_MEM_SYSTEM': <NvBufSurfaceMemType.NVBUF_MEM_SYSTEM: 6>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvBufSurfaceParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvBufSurfaceParams:
        """
...
class NvBufSurfacePlaneParams:
    ...
    def __release_buffer__(self, buffer):
        ...
        """
    @typing.overload
    def cast(self: capsule) -> NvBufSurfacePlaneParams:
        """
...
class NvDsAnalyticsFrameMeta:
    ...
    unique_id: int
    @staticmethod
    def cast(data: capsule) -> NvDsAnalyticsFrameMeta:
        """
...
class NvDsAnalyticsObjInfo:
    """
                    ...
                    :ivar objStatus: *str*, Holds the status string for the tracked object.
    ...
    unique_id: int
    @staticmethod
    def cast(data: capsule) -> NvDsAnalyticsObjInfo:
        """
...
class NvDsBaseMeta:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsBaseMeta:
        """
...
class NvDsComp_BboxInfo:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsComp_BboxInfo:
        """
...
class NvDsCoordinate:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsCoordinate:
        """
...
class NvDsDataType:
    ...
    *Enumerator*. Specifies the type of meta data.
    ...
    Members:
      ...
      NvDsDataType_FP32 : FP32 data type.
    
      NvDsDataType_UINT8 : UINT8 data type.
    
      NvDsDataType_INT8 : INT8 data type.
    
      NvDsDataType_UINT32 : UINT32 data type.
    
      NvDsDataType_INT32 : INT32 data type.
    
      NvDsDataType_FP16 : FP16 data type.
    """
    NvDsDataType_FP16: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_FP16: 7>
    NvDsDataType_FP32: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_FP32: 0>
    NvDsDataType_INT32: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_INT32: 4>
    NvDsDataType_INT8: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_INT8: 2>
    NvDsDataType_UINT32: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_UINT32: 3>
    NvDsDataType_UINT8: typing.ClassVar[NvDsDataType]  # value = <NvDsDataType.NvDsDataType_UINT8: 1>
    __members__: typing.ClassVar[dict[str, NvDsDataType]]  # value = {'NvDsDataType_FP32': <NvDsDataType.NvDsDataType_FP32: 0>, 'NvDsDataType_UINT8': <NvDsDataType.NvDsDataType_UINT8: 1>, 'NvDsDataType_INT8': <NvDsDataType.NvDsDataType_INT8: 2>, 'NvDsDataType_UINT32': <NvDsDataType.NvDsDataType_UINT32: 3>, 'NvDsDataType_INT32': <NvDsDataType.NvDsDataType_INT32: 4>, 'NvDsDataType_FP16': <NvDsDataType.NvDsDataType_FP16: 7>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsEvent:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsEvent:
        """
...
class NvDsEventType:
    ...
    *Enumerator*. Event type flags.
    ...
    """
    NVDS_EVENT_CUSTOM: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_CUSTOM: 257>
    NVDS_EVENT_EMPTY: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_EMPTY: 4>
    NVDS_EVENT_ENTRY: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_ENTRY: 0>
    NVDS_EVENT_EXIT: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_EXIT: 1>
    NVDS_EVENT_FORCE32: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_FORCE32: 2147483647>
    NVDS_EVENT_MOVING: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_MOVING: 2>
    NVDS_EVENT_PARKED: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_PARKED: 5>
    NVDS_EVENT_RESERVED: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_RESERVED: 256>
    NVDS_EVENT_RESET: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_RESET: 6>
    NVDS_EVENT_STOPPED: typing.ClassVar[NvDsEventType]  # value = <NvDsEventType.NVDS_EVENT_STOPPED: 3>
    __members__: typing.ClassVar[dict[str, NvDsEventType]]  # value = {'NVDS_EVENT_ENTRY': <NvDsEventType.NVDS_EVENT_ENTRY: 0>, 'NVDS_EVENT_EXIT': <NvDsEventType.NVDS_EVENT_EXIT: 1>, 'NVDS_EVENT_MOVING': <NvDsEventType.NVDS_EVENT_MOVING: 2>, 'NVDS_EVENT_STOPPED': <NvDsEventType.NVDS_EVENT_STOPPED: 3>, 'NVDS_EVENT_EMPTY': <NvDsEventType.NVDS_EVENT_EMPTY: 4>, 'NVDS_EVENT_PARKED': <NvDsEventType.NVDS_EVENT_PARKED: 5>, 'NVDS_EVENT_RESET': <NvDsEventType.NVDS_EVENT_RESET: 6>, 'NVDS_EVENT_RESERVED': <NvDsEventType.NVDS_EVENT_RESERVED: 256>, 'NVDS_EVENT_CUSTOM': <NvDsEventType.NVDS_EVENT_CUSTOM: 257>, 'NVDS_EVENT_FORCE32': <NvDsEventType.NVDS_EVENT_FORCE32: 2147483647>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsFaceObject:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsFaceObject:
        """
...
class NvDsFaceObjectWithExt:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsFaceObjectWithExt:
        """
...
class NvDsGeoLocation:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsGeoLocation:
        """
...
class NvDsInferAttribute:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferAttribute:
        """
...
class NvDsInferDataType:
    ...
    *Enumerator*, Specifies the data type of a layer.
    ...
    Members:
      ...
      INT32 : INT32 format.
    """
    FLOAT: typing.ClassVar[NvDsInferDataType]  # value = <NvDsInferDataType.FLOAT: 0>
    HALF: typing.ClassVar[NvDsInferDataType]  # value = <NvDsInferDataType.HALF: 1>
    INT32: typing.ClassVar[NvDsInferDataType]  # value = <NvDsInferDataType.INT32: 3>
    INT8: typing.ClassVar[NvDsInferDataType]  # value = <NvDsInferDataType.INT8: 2>
    __members__: typing.ClassVar[dict[str, NvDsInferDataType]]  # value = {'FLOAT': <NvDsInferDataType.FLOAT: 0>, 'HALF': <NvDsInferDataType.HALF: 1>, 'INT8': <NvDsInferDataType.INT8: 2>, 'INT32': <NvDsInferDataType.INT32: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsInferDims:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferDims:
        """
...
class NvDsInferDimsCHW:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferDimsCHW:
        """
...
class NvDsInferLayerInfo:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferLayerInfo:
        """
...
class NvDsInferNetworkInfo:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferNetworkInfo:
        """
...
class NvDsInferObjectDetectionInfo:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsInferObjectDetectionInfo:
        """
        cast given object/data to :class:`NvDsInferObjectDetectionInfo`, call pyds.NvDsInferObjectDetectionInfo.cast(data)
        """
    @typing.overload
...
class NvDsMeta:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsMeta:
        """
...
class NvDsMetaPool:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsMetaPool:
        """
...
class NvDsMetaType:
    ...
    Members:
      ...
      NVDS_TRACKER_BATCH_REID_META : The ReID vectors for the whole batch generated by tracker. 
    
      NVDS_TRACKER_OBJ_REID_META : The ReID information for a single object generated by tracker.  
      ...
      NVDS_PREPROCESS_BATCH_META : NVDS_PREPROCESS_BATCH_META
    
      NVDS_FRAME_META_NVDSANALYTICS : Specifies metadata type for nvdsanalytics frame.
    
      NVDS_OBJ_META_NVDSANALYTICS : Specifies metadata type for nvdsanalytics object
    """
    NVDSINFER_SEGMENTATION_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDSINFER_SEGMENTATION_META: 13>
    NVDSINFER_TENSOR_OUTPUT_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDSINFER_TENSOR_OUTPUT_META: 12>
    NVDS_AUDIO_BATCH_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_AUDIO_BATCH_META: 25>
    NVDS_AUDIO_FRAME_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_AUDIO_FRAME_META: 26>
    NVDS_BATCH_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_BATCH_META: 1>
    NVDS_CLASSIFIER_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_CLASSIFIER_META: 5>
    NVDS_CROP_IMAGE_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_CROP_IMAGE_META: 14>
    NVDS_DISPLAY_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_DISPLAY_META: 4>
    NVDS_EVENT_MSG_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_EVENT_MSG_META: 9>
    NVDS_FORCE32_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_FORCE32_META: 2147483647>
    NVDS_FRAME_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_FRAME_META: 2>
    NVDS_FRAME_META_NVDSANALYTICS: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_FRAME_META_NVDSANALYTICS: 32>
    NVDS_GST_CUSTOM_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_GST_CUSTOM_META: 4096>
    NVDS_INVALID_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_INVALID_META: -1>
    NVDS_LABEL_INFO_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_LABEL_INFO_META: 6>
    NVDS_LATENCY_MEASUREMENT_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_LATENCY_MEASUREMENT_META: 11>
    NVDS_OBJ_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_OBJ_META: 3>
    NVDS_OBJ_META_NVDSANALYTICS: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_OBJ_META_NVDSANALYTICS: 33>
    NVDS_OPTICAL_FLOW_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_OPTICAL_FLOW_META: 10>
    NVDS_PAYLOAD_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_PAYLOAD_META: 8>
    NVDS_PREPROCESS_BATCH_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_PREPROCESS_BATCH_META: 28>
    NVDS_RESERVED_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_RESERVED_META: 4095>
    NVDS_START_USER_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_START_USER_META: 8193>
    NVDS_TRACKER_BATCH_REID_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_TRACKER_BATCH_REID_META: 16>
    NVDS_TRACKER_OBJ_REID_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_TRACKER_OBJ_REID_META: 17>
    NVDS_TRACKER_PAST_FRAME_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_TRACKER_PAST_FRAME_META: 15>
    NVDS_USER_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_USER_META: 7>
    __members__: typing.ClassVar[dict[str, NvDsMetaType]]  # value = {'NVDS_INVALID_META': <NvDsMetaType.NVDS_INVALID_META: -1>, 'NVDS_BATCH_META': <NvDsMetaType.NVDS_BATCH_META: 1>, 'NVDS_FRAME_META': <NvDsMetaType.NVDS_FRAME_META: 2>, 'NVDS_OBJ_META': <NvDsMetaType.NVDS_OBJ_META: 3>, 'NVDS_DISPLAY_META': <NvDsMetaType.NVDS_DISPLAY_META: 4>, 'NVDS_CLASSIFIER_META': <NvDsMetaType.NVDS_CLASSIFIER_META: 5>, 'NVDS_LABEL_INFO_META': <NvDsMetaType.NVDS_LABEL_INFO_META: 6>, 'NVDS_USER_META': <NvDsMetaType.NVDS_USER_META: 7>, 'NVDS_PAYLOAD_META': <NvDsMetaType.NVDS_PAYLOAD_META: 8>, 'NVDS_EVENT_MSG_META': <NvDsMetaType.NVDS_EVENT_MSG_META: 9>, 'NVDS_OPTICAL_FLOW_META': <NvDsMetaType.NVDS_OPTICAL_FLOW_META: 10>, 'NVDS_LATENCY_MEASUREMENT_META': <NvDsMetaType.NVDS_LATENCY_MEASUREMENT_META: 11>, 'NVDSINFER_TENSOR_OUTPUT_META': <NvDsMetaType.NVDSINFER_TENSOR_OUTPUT_META: 12>, 'NVDSINFER_SEGMENTATION_META': <NvDsMetaType.NVDSINFER_SEGMENTATION_META: 13>, 'NVDS_CROP_IMAGE_META': <NvDsMetaType.NVDS_CROP_IMAGE_META: 14>, 'NVDS_TRACKER_PAST_FRAME_META': <NvDsMetaType.NVDS_TRACKER_PAST_FRAME_META: 15>, 'NVDS_TRACKER_BATCH_REID_META': <NvDsMetaType.NVDS_TRACKER_BATCH_REID_META: 16>, 'NVDS_TRACKER_OBJ_REID_META': <NvDsMetaType.NVDS_TRACKER_OBJ_REID_META: 17>, 'NVDS_AUDIO_BATCH_META': <NvDsMetaType.NVDS_AUDIO_BATCH_META: 25>, 'NVDS_AUDIO_FRAME_META': <NvDsMetaType.NVDS_AUDIO_FRAME_META: 26>, 'NVDS_RESERVED_META': <NvDsMetaType.NVDS_RESERVED_META: 4095>, 'NVDS_GST_CUSTOM_META': <NvDsMetaType.NVDS_GST_CUSTOM_META: 4096>, 'NVDS_START_USER_META': <NvDsMetaType.NVDS_START_USER_META: 8193>, 'NVDS_FORCE32_META': <NvDsMetaType.NVDS_FORCE32_META: 2147483647>, 'NVDS_PREPROCESS_BATCH_META': <NvDsMetaType.NVDS_PREPROCESS_BATCH_META: 28>, 'NVDS_FRAME_META_NVDSANALYTICS': <NvDsMetaType.NVDS_FRAME_META_NVDSANALYTICS: 32>, 'NVDS_OBJ_META_NVDSANALYTICS': <NvDsMetaType.NVDS_OBJ_META_NVDSANALYTICS: 33>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class NvDsObjEncOutParams:
    """
    
                    output parameters of NVDS_CROP_IMAGE_META
    
                    :ivar outBuffer: *np.array of char*, The output buffer JPEG Encoded Object.
    """
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: int) -> NvDsObjEncOutParams:
        """
        cast given object/data to :class:`NvDsObjEncOutParams`, call pyds.NvDsObjEncOutParams.cast(data)
        """
    @typing.overload
    def cast(self: capsule) -> NvDsObjEncOutParams:
        """
        cast given object/data to :class:`NvDsObjEncOutParams`, call pyds.NvDsObjEncOutParams.cast(data)
        """
    def outBuffer(self) -> numpy.ndarray:
        ...
class NvDsObjEncUsrArgs:
    """
                    ...
                    :ivar calcEncodeTime: *bool*, Boolean variable to calculate time of encode.
    """
    attachUsrMeta: bool
    calcEncodeTime: bool
    fileNameImg: str
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: int) -> NvDsObjEncUsrArgs:
        """
        cast given object/data to :class:`NvDsObjEncUsrArgs`, call pyds.NvDsObjEncUsrArgs.cast(data)
        """
    @typing.overload
    def cast(self: capsule) -> NvDsObjEncUsrArgs:
        """
        cast given object/data to :class:`NvDsObjEncUsrArgs`, call pyds.NvDsObjEncUsrArgs.cast(data)
        """
class NvDsObjReid:
    ...
    def __init__(self) -> None:
        ...
    def cast(self: capsule) -> NvDsObjReid:
        """
        cast given object/data to :class:`NvDsObjReid`, call pyds.NvDsObjReid.cast(data)
        """
    def get_host_reid_vector(self) -> numpy.ndarray[numpy.float32]:
        """
...
class NvDsObjectSignature:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsObjectSignature:
        """
...
class NvDsObjectType:
    ...
    *Enumerator*. Object type flags.
    ...
    """
    NVDS_OBEJCT_TYPE_FORCE32: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBEJCT_TYPE_FORCE32: 2147483647>
    NVDS_OBJECT_TYPE_BAG: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_BAG: 3>
    NVDS_OBJECT_TYPE_BICYCLE: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_BICYCLE: 4>
    NVDS_OBJECT_TYPE_CUSTOM: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_CUSTOM: 257>
    NVDS_OBJECT_TYPE_FACE: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_FACE: 2>
    NVDS_OBJECT_TYPE_FACE_EXT: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_FACE_EXT: 8>
    NVDS_OBJECT_TYPE_PERSON: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON: 1>
    NVDS_OBJECT_TYPE_PERSON_EXT: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON_EXT: 7>
    NVDS_OBJECT_TYPE_RESERVED: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_RESERVED: 256>
    NVDS_OBJECT_TYPE_ROADSIGN: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_ROADSIGN: 5>
    NVDS_OBJECT_TYPE_UNKNOWN: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_UNKNOWN: 258>
    NVDS_OBJECT_TYPE_VEHICLE: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE: 0>
    NVDS_OBJECT_TYPE_VEHICLE_EXT: typing.ClassVar[NvDsObjectType]  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE_EXT: 6>
    __members__: typing.ClassVar[dict[str, NvDsObjectType]]  # value = {'NVDS_OBJECT_TYPE_VEHICLE': <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE: 0>, 'NVDS_OBJECT_TYPE_PERSON': <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON: 1>, 'NVDS_OBJECT_TYPE_FACE': <NvDsObjectType.NVDS_OBJECT_TYPE_FACE: 2>, 'NVDS_OBJECT_TYPE_BAG': <NvDsObjectType.NVDS_OBJECT_TYPE_BAG: 3>, 'NVDS_OBJECT_TYPE_BICYCLE': <NvDsObjectType.NVDS_OBJECT_TYPE_BICYCLE: 4>, 'NVDS_OBJECT_TYPE_ROADSIGN': <NvDsObjectType.NVDS_OBJECT_TYPE_ROADSIGN: 5>, 'NVDS_OBJECT_TYPE_VEHICLE_EXT': <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE_EXT: 6>, 'NVDS_OBJECT_TYPE_PERSON_EXT': <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON_EXT: 7>, 'NVDS_OBJECT_TYPE_FACE_EXT': <NvDsObjectType.NVDS_OBJECT_TYPE_FACE_EXT: 8>, 'NVDS_OBJECT_TYPE_RESERVED': <NvDsObjectType.NVDS_OBJECT_TYPE_RESERVED: 256>, 'NVDS_OBJECT_TYPE_CUSTOM': <NvDsObjectType.NVDS_OBJECT_TYPE_CUSTOM: 257>, 'NVDS_OBJECT_TYPE_UNKNOWN': <NvDsObjectType.NVDS_OBJECT_TYPE_UNKNOWN: 258>, 'NVDS_OBEJCT_TYPE_FORCE32': <NvDsObjectType.NVDS_OBEJCT_TYPE_FORCE32: 2147483647>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsPayload:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsPayload:
        """
...
class NvDsPayloadType:
    ...
    *Enumerator*. Payload type flags.
    ...
    """
    NVDS_PAYLOAD_CUSTOM: typing.ClassVar[NvDsPayloadType]  # value = <NvDsPayloadType.NVDS_PAYLOAD_CUSTOM: 257>
    NVDS_PAYLOAD_DEEPSTREAM: typing.ClassVar[NvDsPayloadType]  # value = <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM: 0>
    NVDS_PAYLOAD_DEEPSTREAM_MINIMAL: typing.ClassVar[NvDsPayloadType]  # value = <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM_MINIMAL: 1>
    NVDS_PAYLOAD_FORCE32: typing.ClassVar[NvDsPayloadType]  # value = <NvDsPayloadType.NVDS_PAYLOAD_FORCE32: 2147483647>
    NVDS_PAYLOAD_RESERVED: typing.ClassVar[NvDsPayloadType]  # value = <NvDsPayloadType.NVDS_PAYLOAD_RESERVED: 256>
    __members__: typing.ClassVar[dict[str, NvDsPayloadType]]  # value = {'NVDS_PAYLOAD_DEEPSTREAM': <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM: 0>, 'NVDS_PAYLOAD_DEEPSTREAM_MINIMAL': <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM_MINIMAL: 1>, 'NVDS_PAYLOAD_RESERVED': <NvDsPayloadType.NVDS_PAYLOAD_RESERVED: 256>, 'NVDS_PAYLOAD_CUSTOM': <NvDsPayloadType.NVDS_PAYLOAD_CUSTOM: 257>, 'NVDS_PAYLOAD_FORCE32': <NvDsPayloadType.NVDS_PAYLOAD_FORCE32: 2147483647>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsPersonObjectExt:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsPersonObjectExt:
        """
    ...
    def cast(self: int) -> NvDsPersonObjectExt:
        ...
        cast given object/data to :class:`NvDsPersonObjectExt`, call pyds.NvDsPersonObjectExt.cast(data)
        """
class NvDsPreProcessTensorMeta:
    """
                    ...
                    :ivar maintain_aspect_ratio: *bool*, parameter to inform whether aspect ratio is maintained in the preprocess tensor.
    """
    buffer_size: int
    data_type: NvDsDataType
    gpu_id: int
    maintain_aspect_ratio: int
    meta_id: int
    private_data: capsule
    raw_tensor_buffer: capsule
    tensor_name: str
    tensor_shape: list[int]
    def __init__(self) -> None:
        ...
    def cast(self: capsule) -> NvDsPreProcessTensorMeta:
        """
        Cast given object/data to :class:`NvDsPreProcessTensorMeta`, call pyds.NvDsPreProcessTensorMeta.cast(data)
        """
class NvDsRect:
    """
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsRect:
        """
...
class NvDsRoiMeta:
    """
                    ...
                    :ivar object_meta: pointer to :class:`NvDsObjectMeta`, deepstream object meta.
    """
    classifier_meta_list: GList
    converted_buffer: NvBufSurfaceParams
    frame_meta: NvDsFrameMeta
    object_meta: NvDsObjectMeta
    offset_left: float
    offset_top: float
    roi: NvOSD_RectParams
    roi_user_meta_list: GList
    scale_ratio_x: float
    scale_ratio_y: float
    def __init__(self) -> None:
        ...
    def cast(self: capsule) -> NvDsRoiMeta:
        """
        Casts a pointer to :class:`NvDsRoiMeta`
        """
class NvDsTargetMiscDataBatch:
    ...
    def cast(self: capsule) -> NvDsTargetMiscDataBatch:
        ...
        """
    def list(self) -> typing.Iterator[NvDsTargetMiscDataStream]:
        """
...
class NvDsTargetMiscDataObject:
    ...
    def cast(self: capsule) -> NvDsTargetMiscDataObject:
        ...
        """
    def list(self) -> typing.Iterator[NvDsTargetMiscDataFrame]:
        """
...
class NvDsTargetMiscDataStream:
    ...
    def cast(self: capsule) -> NvDsTargetMiscDataStream:
        ...
        """
    def list(self) -> typing.Iterator[NvDsTargetMiscDataObject]:
        """
...
class NvDsUnitType:
    ...
    *Enumerator*. Specifies the type of meta data.
    ...
    Members:
      ...
      NvDsUnitType_FullFrame : Full frames.
    
      NvDsUnitType_ROI : Region of Interests (ROIs).
    
      NvDsUnitType_Object : Object mode.
    """
    NvDsUnitType_FullFrame: typing.ClassVar[NvDsUnitType]  # value = <NvDsUnitType.NvDsUnitType_FullFrame: 0>
    NvDsUnitType_Object: typing.ClassVar[NvDsUnitType]  # value = <NvDsUnitType.NvDsUnitType_Object: 2>
    NvDsUnitType_ROI: typing.ClassVar[NvDsUnitType]  # value = <NvDsUnitType.NvDsUnitType_ROI: 1>
    __members__: typing.ClassVar[dict[str, NvDsUnitType]]  # value = {'NvDsUnitType_FullFrame': <NvDsUnitType.NvDsUnitType_FullFrame: 0>, 'NvDsUnitType_ROI': <NvDsUnitType.NvDsUnitType_ROI: 1>, 'NvDsUnitType_Object': <NvDsUnitType.NvDsUnitType_Object: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvDsVehicleObjectExt:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvDsVehicleObjectExt:
        """
...
class NvOFFlowVector:
    ...
    flowy: int
    @typing.overload
    def cast(self: capsule) -> NvOFFlowVector:
        """
...
class NvOSD_ArrowParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_ArrowParams:
        """
...
class NvOSD_Arrow_Head_Direction:
    ...
    *Enumerator*. Lists arrow head positions.
    ...
    """
    BOTH_HEAD: typing.ClassVar[NvOSD_Arrow_Head_Direction]  # value = <NvOSD_Arrow_Head_Direction.BOTH_HEAD: 2>
    END_HEAD: typing.ClassVar[NvOSD_Arrow_Head_Direction]  # value = <NvOSD_Arrow_Head_Direction.END_HEAD: 1>
    START_HEAD: typing.ClassVar[NvOSD_Arrow_Head_Direction]  # value = <NvOSD_Arrow_Head_Direction.START_HEAD: 0>
    __members__: typing.ClassVar[dict[str, NvOSD_Arrow_Head_Direction]]  # value = {'START_HEAD': <NvOSD_Arrow_Head_Direction.START_HEAD: 0>, 'END_HEAD': <NvOSD_Arrow_Head_Direction.END_HEAD: 1>, 'BOTH_HEAD': <NvOSD_Arrow_Head_Direction.BOTH_HEAD: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvOSD_CircleParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_CircleParams:
        """
...
class NvOSD_ColorParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_ColorParams:
        """
...
class NvOSD_Color_info:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_Color_info:
        """
...
class NvOSD_FontParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FontParams:
        """
...
class NvOSD_FrameArrowParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FrameArrowParams:
        """
...
class NvOSD_FrameCircleParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FrameCircleParams:
        """
...
class NvOSD_FrameLineParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FrameLineParams:
        """
...
class NvOSD_FrameRectParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FrameRectParams:
        """
...
class NvOSD_FrameTextParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_FrameTextParams:
        """
...
class NvOSD_LineParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_LineParams:
        """
...
class NvOSD_MaskParams:
    ...
    def __init__(self) -> None:
        ...
    def alloc_mask_array(self) -> numpy.ndarray:
        """
...
class NvOSD_Mode:
    ...
    *Enumerator*. List modes used to overlay boxes and text.
    ...
    """
    MODE_CPU: typing.ClassVar[NvOSD_Mode]  # value = <NvOSD_Mode.MODE_CPU: 0>
    MODE_GPU: typing.ClassVar[NvOSD_Mode]  # value = <NvOSD_Mode.MODE_GPU: 1>
    MODE_NONE: typing.ClassVar[NvOSD_Mode]  # value = <NvOSD_Mode.MODE_NONE: 2>
    __members__: typing.ClassVar[dict[str, NvOSD_Mode]]  # value = {'MODE_CPU': <NvOSD_Mode.MODE_CPU: 0>, 'MODE_GPU': <NvOSD_Mode.MODE_GPU: 1>, 'MODE_NONE': <NvOSD_Mode.MODE_NONE: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class NvOSD_RectParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_RectParams:
        """
...
class NvOSD_TextParams:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def cast(self: capsule) -> NvOSD_TextParams:
        """
...
class ROI_STATUS_360D:
    ...
    *Enumerator*. Defines DeepStream 360d metadata.
    ...
    """
    INSIDE_AISLE_360D: typing.ClassVar[ROI_STATUS_360D]  # value = <ROI_STATUS_360D.INSIDE_AISLE_360D: 4>
    ROI_ENTRY_360D: typing.ClassVar[ROI_STATUS_360D]  # value = <ROI_STATUS_360D.ROI_ENTRY_360D: 1>
    ROI_EXIT_360D: typing.ClassVar[ROI_STATUS_360D]  # value = <ROI_STATUS_360D.ROI_EXIT_360D: 2>
    __members__: typing.ClassVar[dict[str, ROI_STATUS_360D]]  # value = {'ROI_ENTRY_360D': <ROI_STATUS_360D.ROI_ENTRY_360D: 1>, 'ROI_EXIT_360D': <ROI_STATUS_360D.ROI_EXIT_360D: 2>, 'INSIDE_AISLE_360D': <ROI_STATUS_360D.INSIDE_AISLE_360D: 4>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
def NvBufSurfaceCopy(srcSurf: NvBufSurface, dstSurf: NvBufSurface) -> int:
    ...
    """
def NvBufSurfaceCreate(surf: NvBufSurface, batchSize: int, params: NvBufSurfaceCreateParams) -> int:
    """
...
def NvBufSurfaceDestroy(surf: NvBufSurface) -> int:
    """
                ...
                :returns: 0 for success, -1 for failure.
    """
def NvBufSurfaceFromFd(dmabuf: int, buffer: capsule) -> int:
    """
                ...
                :returns: 0 for success, -1 for failure.
    """
def NvBufSurfaceMap(surf: NvBufSurface, index: int, plane: int, type: NvBufSurfaceMemMapFlags) -> int:
    """
...
def alloc_nvds_event() -> NvDsEvent:
    ...
    """
def alloc_nvds_event_msg_meta(arg0: NvDsUserMeta) -> NvDsEventMsgMeta:
    """
...
def free_buffer(buffer: int) -> None:
    ...
    """
def free_gbuffer(buffer: capsule) -> None:
    """
...
def get_nvds_buf_surface_gpu(gst_buffer: int, batchID: int) -> tuple:
    ...
    """
def get_optical_flow_vectors(data: capsule) -> numpy.ndarray[numpy.float32]:
    """
...
def get_ptr(ptr: capsule) -> int:
    ...
    """
def get_segmentation_masks(data: capsule) -> numpy.ndarray:
    """
...
def glist_get_nvds_vehicle_object(arg0: capsule) -> NvDsVehicleObject:
    ...
def gst_buffer_add_nvds_meta(buffer: _GstBuffer, meta_data: capsule, user_data: capsule, copy_func: ..., release_func: ...) -> _NvDsMeta:
    """
...
def gst_buffer_get_nvds_batch_meta(buffer: int) -> NvDsBatchMeta:
    """
                ...
                ``batch_meta = pyds.gst_buffer_get_nvds_batch_meta(hash(gst_buffer))``
    """
def gst_element_send_nvevent_interval_update(arg0: int, arg1: str, arg2: int) -> bool:
    """
...
def memdup(ptr: int, size: int) -> int:
    ...
def nvds_acquire_classifier_meta_from_pool(batch_meta: NvDsBatchMeta) -> NvDsClassifierMeta:
    """
...
def nvds_acquire_user_meta_from_pool(batch_meta: NvDsBatchMeta) -> NvDsUserMeta:
    ...
    """
def nvds_add_classifier_meta_to_object(obj_meta: NvDsObjectMeta, classifier_meta: NvDsClassifierMeta) -> None:
    """
    ...
    """
def nvds_add_display_meta_to_frame(frame_meta: NvDsFrameMeta, display_meta: NvDsDisplayMeta) -> None:
    """
    ...
    """
def nvds_add_frame_meta_to_batch(batch_meta: NvDsBatchMeta, frame_meta: NvDsFrameMeta) -> None:
    """
    ...
    """
def nvds_add_label_info_meta_to_classifier(classifier_meta: NvDsClassifierMeta, label_info_meta: NvDsLabelInfo) -> None:
    """
    ...
    """
def nvds_add_obj_meta_to_frame(frame_meta: NvDsFrameMeta, obj_meta: NvDsObjectMeta, obj_parent: NvDsObjectMeta) -> None:
    """
    ...
    """
def nvds_add_user_meta_to_batch(batch_meta: NvDsBatchMeta, user_meta: NvDsUserMeta) -> None:
    """
                ...
                :arg user_meta: An object of type :class:`NvDsUserMeta` acquired from user_meta_pool present in :class:`NvDsBatchMeta`.
    """
def nvds_add_user_meta_to_frame(frame_meta: NvDsFrameMeta, user_meta: NvDsUserMeta) -> None:
    """
                ...
                :arg user_meta: An object of type :class:`NvDsUserMeta` acquired from user_meta_pool present in :class:`NvDsBatchMeta`.
    """
def nvds_add_user_meta_to_obj(obj_meta: NvDsObjectMeta, user_meta: NvDsUserMeta) -> None:
    """
    ...
    """
def nvds_batch_meta_copy_func(data: capsule, user_meta: capsule) -> capsule:
    """
    ...
    """
def nvds_batch_meta_release_func(data: capsule, user_data: capsule) -> None:
    """
                ...
                :arg user_data: An object of user specific data
    """
def nvds_clear_batch_user_meta_list(batch_meta: NvDsBatchMeta, meta_list: GList) -> None:
    """
    ...
    """
def nvds_clear_display_meta_list(frame_meta: NvDsFrameMeta, meta_list: GList) -> None:
    """
    ...
    """
def nvds_clear_frame_meta_list(batch_meta: NvDsBatchMeta, meta_list: GList) -> None:
    """
    ...
    """
def nvds_clear_frame_user_meta_list(frame_meta: NvDsFrameMeta, meta_list: GList) -> None:
    """
                ...
                :arg meta_list: An object of type :class:`NvDsUserMetaList` which needs to be cleared
    """
def nvds_clear_meta_list(batch_meta: NvDsBatchMeta, meta_list: GList, meta_pool: NvDsMetaPool) -> GList:
    """
    ...
    """
def nvds_clear_obj_meta_list(frame_meta: NvDsFrameMeta, meta_list: GList) -> None:
    """
    ...
    """
def nvds_clear_obj_user_meta_list(object_meta: NvDsObjectMeta, meta_list: GList) -> None:
    """
                ...
                :arg meta_list: An object of type :class:`NvDsUserMetaList` which needs to be cleared
    """
def nvds_copy_batch_user_meta_list(src_user_meta_list: GList, dst_batch_meta: NvDsBatchMeta) -> None:
    """
    ...
    """
def nvds_copy_display_meta_list(src_display_meta: GList, dst_frame_meta: NvDsFrameMeta) -> None:
    """
    ...
    """
def nvds_copy_frame_meta_list(src_frame_meta_list: GList, dst_batch_meta: NvDsBatchMeta) -> None:
    """
                ...
                :arg dst_batch_meta: An object of type :class:`NvDsBatchMeta`
    """
def nvds_copy_frame_user_meta_list(src_user_meta_list: GList, dst_frame_meta: NvDsFrameMeta) -> None:
    """
                ...
                :arg dst_frame_meta: An object of type :class:`NvDsFrameMeta`
    """
def nvds_copy_obj_meta_list(src_obj_meta_list: GList, dst_object_meta: NvDsFrameMeta) -> None:
    """
...
def nvds_get_current_metadata_info(batch_meta: NvDsBatchMeta) -> int:
    """
                ...
                :arg batch_meta: An object of type :class:`NvDsBatchMeta`
    """
def nvds_get_nth_frame_meta(frame_meta_list: GList, index: int) -> NvDsFrameMeta:
    """
    ...
    """
def nvds_get_user_meta_type(meta_descriptor: str) -> int:
    """
    ...
    """
def nvds_measure_buffer_latency(gst_buffer: int) -> int:
    """
    ...
    """
def nvds_obj_enc_create_context(arg0: int) -> int:
    """
                Create context and return a handle to NvObjEncCtx.
    
                :arg gpu_id: gpu id.
    
                :returns: handle to NvObjEncCtx.
    """
def nvds_obj_enc_destroy_context(ctx: int) -> None:
    """
                Destroy NvObjEncCtx context.
    
                :arg context: handle to NvObjEncCtx.
    """
def nvds_obj_enc_finish(ctx: int) -> None:
    """
                Wait for all enqueued crops to be encoded.
    
                :arg context: handle to NvObjEncCtx.
    """
def nvds_obj_enc_process(ctx: int, args: _NvDsObjEncUsrArgs, gst_buffer: int, obj_meta: NvDsObjectMeta, frame_meta: NvDsFrameMeta) -> bool:
    """
...
def nvds_release_meta_lock(batch_meta: NvDsBatchMeta) -> None:
    """
                ...
                :arg batch_meta: An object of type :class:`NvDsBatchMeta`
    """
def nvds_remove_classifier_meta_from_obj(obj_meta: NvDsObjectMeta, classifier_meta: NvDsClassifierMeta) -> None:
    """
    ...
    """
def nvds_remove_display_meta_from_frame(frame_meta: NvDsFrameMeta, display_meta: NvDsDisplayMeta) -> None:
    """
    ...
    """
def nvds_remove_frame_meta_from_batch(batch_meta: NvDsBatchMeta, frame_meta: NvDsFrameMeta) -> None:
    """
    ...
    """
def nvds_remove_label_info_meta_from_classifier(classifier_meta: NvDsClassifierMeta, label_info_meta: NvDsLabelInfo) -> None:
    """
    ...
    """
def nvds_remove_obj_meta_from_frame(frame_meta: NvDsFrameMeta, obj_meta: NvDsObjectMeta) -> None:
    """
    ...
    """
def nvds_remove_user_meta_from_batch(batch_meta: NvDsBatchMeta, user_meta: NvDsUserMeta) -> None:
    """
    ...
    """
def nvds_remove_user_meta_from_frame(frame_meta: NvDsFrameMeta, user_meta: NvDsUserMeta) -> None:
    """
    ...
    """
def nvds_remove_user_meta_from_object(obj_meta: NvDsObjectMeta, user_meta: NvDsUserMeta) -> None:
    """
...
def unset_callback_funcs() -> None:
    ...
def user_copyfunc(meta: NvDsUserMeta, func: typing.Callable[[capsule, capsule], capsule]) -> None:
    """
    ...
    """
def user_releasefunc(meta: NvDsUserMeta, func: typing.Callable[[capsule, capsule], None]) -> None:
    """
    ...
    """
BOTH_HEAD: NvOSD_Arrow_Head_Direction  # value = <NvOSD_Arrow_Head_Direction.BOTH_HEAD: 2>
END_HEAD: NvOSD_Arrow_Head_Direction  # value = <NvOSD_Arrow_Head_Direction.END_HEAD: 1>
FLOAT: NvDsInferDataType  # value = <NvDsInferDataType.FLOAT: 0>
HALF: NvDsInferDataType  # value = <NvDsInferDataType.HALF: 1>
INSIDE_AISLE_360D: ROI_STATUS_360D  # value = <ROI_STATUS_360D.INSIDE_AISLE_360D: 4>
INT32: NvDsInferDataType  # value = <NvDsInferDataType.INT32: 3>
INT8: NvDsInferDataType  # value = <NvDsInferDataType.INT8: 2>
MODE_CPU: NvOSD_Mode  # value = <NvOSD_Mode.MODE_CPU: 0>
MODE_GPU: NvOSD_Mode  # value = <NvOSD_Mode.MODE_GPU: 1>
MODE_NONE: NvOSD_Mode  # value = <NvOSD_Mode.MODE_NONE: 2>
NVBUF_COLOR_FORMAT_ABGR: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ABGR: 22>
NVBUF_COLOR_FORMAT_ARGB: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_ARGB: 21>
NVBUF_COLOR_FORMAT_BGR: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGR: 28>
NVBUF_COLOR_FORMAT_BGRA: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRA: 20>
NVBUF_COLOR_FORMAT_BGRx: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_BGRx: 24>
NVBUF_COLOR_FORMAT_GRAY8: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_GRAY8: 1>
NVBUF_COLOR_FORMAT_INVALID: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_INVALID: 0>
NVBUF_COLOR_FORMAT_LAST: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_LAST: 104>
NVBUF_COLOR_FORMAT_NV12: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12: 6>
NVBUF_COLOR_FORMAT_NV12_10LE: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE: 29>
NVBUF_COLOR_FORMAT_NV12_10LE_2020: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_2020: 40>
NVBUF_COLOR_FORMAT_NV12_10LE_709: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709: 38>
NVBUF_COLOR_FORMAT_NV12_10LE_709_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_709_ER: 39>
NVBUF_COLOR_FORMAT_NV12_10LE_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_10LE_ER: 37>
NVBUF_COLOR_FORMAT_NV12_12LE: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_12LE: 30>
NVBUF_COLOR_FORMAT_NV12_2020: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_2020: 36>
NVBUF_COLOR_FORMAT_NV12_709: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709: 33>
NVBUF_COLOR_FORMAT_NV12_709_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_709_ER: 34>
NVBUF_COLOR_FORMAT_NV12_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV12_ER: 7>
NVBUF_COLOR_FORMAT_NV21: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21: 8>
NVBUF_COLOR_FORMAT_NV21_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_NV21_ER: 9>
NVBUF_COLOR_FORMAT_RGB: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGB: 27>
NVBUF_COLOR_FORMAT_RGBA: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBA: 19>
NVBUF_COLOR_FORMAT_RGBx: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_RGBx: 23>
NVBUF_COLOR_FORMAT_SIGNED_R16G16: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_SIGNED_R16G16: 41>
NVBUF_COLOR_FORMAT_UYVY: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY: 10>
NVBUF_COLOR_FORMAT_UYVY_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_UYVY_ER: 11>
NVBUF_COLOR_FORMAT_VYUY: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY: 12>
NVBUF_COLOR_FORMAT_VYUY_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_VYUY_ER: 13>
NVBUF_COLOR_FORMAT_YUV420: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420: 2>
NVBUF_COLOR_FORMAT_YUV420_2020: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_2020: 35>
NVBUF_COLOR_FORMAT_YUV420_709: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709: 31>
NVBUF_COLOR_FORMAT_YUV420_709_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_709_ER: 32>
NVBUF_COLOR_FORMAT_YUV420_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV420_ER: 4>
NVBUF_COLOR_FORMAT_YUV444: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUV444: 18>
NVBUF_COLOR_FORMAT_YUYV: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV: 14>
NVBUF_COLOR_FORMAT_YUYV_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YUYV_ER: 15>
NVBUF_COLOR_FORMAT_YVU420: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420: 3>
NVBUF_COLOR_FORMAT_YVU420_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVU420_ER: 5>
NVBUF_COLOR_FORMAT_YVYU: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU: 16>
NVBUF_COLOR_FORMAT_YVYU_ER: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_YVYU_ER: 17>
NVBUF_COLOR_FORMAT_xBGR: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xBGR: 26>
NVBUF_COLOR_FORMAT_xRGB: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_xRGB: 25>
NVBUF_LAYOUT_BLOCK_LINEAR: NvBufSurfaceLayout  # value = <NvBufSurfaceLayout.NVBUF_LAYOUT_BLOCK_LINEAR: 1>
NVBUF_LAYOUT_PITCH: NvBufSurfaceLayout  # value = <NvBufSurfaceLayout.NVBUF_LAYOUT_PITCH: 0>
NVBUF_MAP_READ: NvBufSurfaceMemMapFlags  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ: 0>
NVBUF_MAP_READ_WRITE: NvBufSurfaceMemMapFlags  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_READ_WRITE: 2>
NVBUF_MAP_WRITE: NvBufSurfaceMemMapFlags  # value = <NvBufSurfaceMemMapFlags.NVBUF_MAP_WRITE: 1>
NVBUF_MEM_CUDA_DEVICE: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_DEVICE: 2>
NVBUF_MEM_CUDA_PINNED: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_PINNED: 1>
NVBUF_MEM_CUDA_UNIFIED: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_CUDA_UNIFIED: 3>
NVBUF_MEM_DEFAULT: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_DEFAULT: 0>
NVBUF_MEM_HANDLE: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_HANDLE: 5>
NVBUF_MEM_SURFACE_ARRAY: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_SURFACE_ARRAY: 4>
NVBUF_MEM_SYSTEM: NvBufSurfaceMemType  # value = <NvBufSurfaceMemType.NVBUF_MEM_SYSTEM: 6>
NVDSINFER_SEGMENTATION_META: NvDsMetaType  # value = <NvDsMetaType.NVDSINFER_SEGMENTATION_META: 13>
NVDSINFER_TENSOR_OUTPUT_META: NvDsMetaType  # value = <NvDsMetaType.NVDSINFER_TENSOR_OUTPUT_META: 12>
NVDS_AUDIO_BATCH_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_AUDIO_BATCH_META: 25>
NVDS_AUDIO_FRAME_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_AUDIO_FRAME_META: 26>
NVDS_BATCH_GST_META: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_BATCH_GST_META: 4097>
NVDS_BATCH_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_BATCH_META: 1>
NVDS_CLASSIFIER_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_CLASSIFIER_META: 5>
NVDS_CROP_IMAGE_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_CROP_IMAGE_META: 14>
NVDS_DECODER_GST_META: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_DECODER_GST_META: 4098>
NVDS_DEWARPER_GST_META: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_DEWARPER_GST_META: 4099>
NVDS_DISPLAY_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_DISPLAY_META: 4>
NVDS_EVENT_CUSTOM: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_CUSTOM: 257>
NVDS_EVENT_EMPTY: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_EMPTY: 4>
NVDS_EVENT_ENTRY: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_ENTRY: 0>
NVDS_EVENT_EXIT: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_EXIT: 1>
NVDS_EVENT_FORCE32: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_FORCE32: 2147483647>
NVDS_EVENT_MOVING: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_MOVING: 2>
NVDS_EVENT_MSG_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_EVENT_MSG_META: 9>
NVDS_EVENT_PARKED: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_PARKED: 5>
NVDS_EVENT_RESERVED: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_RESERVED: 256>
NVDS_EVENT_RESET: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_RESET: 6>
NVDS_EVENT_STOPPED: NvDsEventType  # value = <NvDsEventType.NVDS_EVENT_STOPPED: 3>
NVDS_FORCE32_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_FORCE32_META: 2147483647>
NVDS_FRAME_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_FRAME_META: 2>
NVDS_FRAME_META_NVDSANALYTICS: NvDsMetaType  # value = <NvDsMetaType.NVDS_FRAME_META_NVDSANALYTICS: 32>
NVDS_GST_CUSTOM_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_GST_CUSTOM_META: 4096>
NVDS_GST_INVALID_META: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_GST_INVALID_META: -1>
NVDS_GST_META_FORCE32: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_GST_META_FORCE32: 2147483647>
NVDS_INVALID_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_INVALID_META: -1>
NVDS_LABEL_INFO_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_LABEL_INFO_META: 6>
NVDS_LATENCY_MEASUREMENT_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_LATENCY_MEASUREMENT_META: 11>
NVDS_OBEJCT_TYPE_FORCE32: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBEJCT_TYPE_FORCE32: 2147483647>
NVDS_OBJECT_TYPE_BAG: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_BAG: 3>
NVDS_OBJECT_TYPE_BICYCLE: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_BICYCLE: 4>
NVDS_OBJECT_TYPE_CUSTOM: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_CUSTOM: 257>
NVDS_OBJECT_TYPE_FACE: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_FACE: 2>
NVDS_OBJECT_TYPE_FACE_EXT: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_FACE_EXT: 8>
NVDS_OBJECT_TYPE_PERSON: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON: 1>
NVDS_OBJECT_TYPE_PERSON_EXT: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_PERSON_EXT: 7>
NVDS_OBJECT_TYPE_RESERVED: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_RESERVED: 256>
NVDS_OBJECT_TYPE_ROADSIGN: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_ROADSIGN: 5>
NVDS_OBJECT_TYPE_UNKNOWN: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_UNKNOWN: 258>
NVDS_OBJECT_TYPE_VEHICLE: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE: 0>
NVDS_OBJECT_TYPE_VEHICLE_EXT: NvDsObjectType  # value = <NvDsObjectType.NVDS_OBJECT_TYPE_VEHICLE_EXT: 6>
NVDS_OBJ_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_OBJ_META: 3>
NVDS_OBJ_META_NVDSANALYTICS: NvDsMetaType  # value = <NvDsMetaType.NVDS_OBJ_META_NVDSANALYTICS: 33>
NVDS_OPTICAL_FLOW_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_OPTICAL_FLOW_META: 10>
NVDS_PAYLOAD_CUSTOM: NvDsPayloadType  # value = <NvDsPayloadType.NVDS_PAYLOAD_CUSTOM: 257>
NVDS_PAYLOAD_DEEPSTREAM: NvDsPayloadType  # value = <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM: 0>
NVDS_PAYLOAD_DEEPSTREAM_MINIMAL: NvDsPayloadType  # value = <NvDsPayloadType.NVDS_PAYLOAD_DEEPSTREAM_MINIMAL: 1>
NVDS_PAYLOAD_FORCE32: NvDsPayloadType  # value = <NvDsPayloadType.NVDS_PAYLOAD_FORCE32: 2147483647>
NVDS_PAYLOAD_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_PAYLOAD_META: 8>
NVDS_PAYLOAD_RESERVED: NvDsPayloadType  # value = <NvDsPayloadType.NVDS_PAYLOAD_RESERVED: 256>
NVDS_PREPROCESS_BATCH_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_PREPROCESS_BATCH_META: 28>
NVDS_RESERVED_GST_META: GstNvDsMetaType  # value = <GstNvDsMetaType.NVDS_RESERVED_GST_META: 8192>
NVDS_RESERVED_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_RESERVED_META: 4095>
NVDS_START_USER_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_START_USER_META: 8193>
NVDS_TRACKER_BATCH_REID_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_TRACKER_BATCH_REID_META: 16>
NVDS_TRACKER_OBJ_REID_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_TRACKER_OBJ_REID_META: 17>
NVDS_TRACKER_PAST_FRAME_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_TRACKER_PAST_FRAME_META: 15>
NVDS_USER_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_USER_META: 7>
NvDsDataType_FP16: NvDsDataType  # value = <NvDsDataType.NvDsDataType_FP16: 7>
NvDsDataType_FP32: NvDsDataType  # value = <NvDsDataType.NvDsDataType_FP32: 0>
NvDsDataType_INT32: NvDsDataType  # value = <NvDsDataType.NvDsDataType_INT32: 4>
NvDsDataType_INT8: NvDsDataType  # value = <NvDsDataType.NvDsDataType_INT8: 2>
NvDsDataType_UINT32: NvDsDataType  # value = <NvDsDataType.NvDsDataType_UINT32: 3>
NvDsDataType_UINT8: NvDsDataType  # value = <NvDsDataType.NvDsDataType_UINT8: 1>
NvDsUnitType_FullFrame: NvDsUnitType  # value = <NvDsUnitType.NvDsUnitType_FullFrame: 0>
NvDsUnitType_Object: NvDsUnitType  # value = <NvDsUnitType.NvDsUnitType_Object: 2>
NvDsUnitType_ROI: NvDsUnitType  # value = <NvDsUnitType.NvDsUnitType_ROI: 1>
ROI_ENTRY_360D: ROI_STATUS_360D  # value = <ROI_STATUS_360D.ROI_ENTRY_360D: 1>
ROI_EXIT_360D: ROI_STATUS_360D  # value = <ROI_STATUS_360D.ROI_EXIT_360D: 2>
START_HEAD: NvOSD_Arrow_Head_Direction  # value = <NvOSD_Arrow_Head_Direction.START_HEAD: 0>
