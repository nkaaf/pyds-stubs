...
def get_nvds_buf_surface(gst_buffer: int, batchID: int) -> array:
    """
                ...
                :arg batchID: batch_id of the frame to be processed. This indicates the frame's index within `NvBufSurface`
    """
...
def gst_buffer_get_nvds_batch_meta(buffer: int) -> NvDsBatchMeta:
    """
                ...
                ``batch_meta = pyds.gst_buffer_get_nvds_batch_meta(hash(gst_buffer))``
    """
def gst_nvevent_new_stream_reset(arg0: int) -> _GstEvent:
    """
