...
class NvOSD_MaskParams:
    ...
    def __init__(self) -> None:
        ...
    def alloc_mask_array(self) -> array:
        """
...
class NvOSD_Mode:
    ...
    *Enumerator*. List modes used to overlay boxes and text.
    ...
    __members__: typing.ClassVar[dict[str, NvOSD_Mode]]  # value = {'MODE_CPU': NvOSD_Mode.MODE_CPU, 'MODE_GPU': NvOSD_Mode.MODE_GPU, 'MODE_NONE': NvOSD_Mode.MODE_NONE}
    @staticmethod
    def __eq__(*args, **kwargs):
        """
        (self: object, arg0: object) -> bool
...
def get_nvds_LayerInfo(arg0: capsule, arg1: int) -> NvDsInferLayerInfo:
    ...
def get_nvds_buf_surface(gst_buffer: int, batchID: int) -> array:
    """
...
def get_nvds_buf_surface_gpu(gst_buffer: int, batchID: int) -> tuple:
    ...
    """
def get_optical_flow_vectors(data: capsule) -> numpy.ndarray[float32]:
    """
