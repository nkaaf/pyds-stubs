...
![Python Version from PEP 621 TOML](https://img.shields.io/python/required-version-toml?tomlFilePath=https%3A%2F%2Fraw.githubusercontent.com%2Fnkaaf%2Fpyds-stubs%2Frefs%2Fheads%2F1.0.2-stubs%2Fpyproject.toml&style=for-the-badge)
...
The stubs are generated by pybind11-stubgen (2.5.5 - modified). It is contained in the 'gen' extra
dependency requirements. To generate the stubs execute the following script. It adds the shared
object path of pyds to the python search path and executes pybind11-stubgen after that.
