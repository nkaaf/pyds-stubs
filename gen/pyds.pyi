...
class NvBufSurfaceColorFormat:
    ...
    *Enumerator*. Specifies color formats for :class:`NvBufSurface`.
    ...
    NVBUF_COLOR_FORMAT_LAST: typing.ClassVar[NvBufSurfaceColorFormat]  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_LAST: 93>
...
class NvDsMetaType:
    ...
    NVDS_AUDIO_BATCH_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_AUDIO_BATCH_META: 24>
    NVDS_AUDIO_FRAME_META: typing.ClassVar[NvDsMetaType]  # value = <NvDsMetaType.NVDS_AUDIO_FRAME_META: 25>
...
NVBUF_COLOR_FORMAT_LAST: NvBufSurfaceColorFormat  # value = <NvBufSurfaceColorFormat.NVBUF_COLOR_FORMAT_LAST: 93>
...
NVDS_AUDIO_BATCH_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_AUDIO_BATCH_META: 24>
NVDS_AUDIO_FRAME_META: NvDsMetaType  # value = <NvDsMetaType.NVDS_AUDIO_FRAME_META: 25>
